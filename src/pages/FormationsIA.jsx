                ...
                >
                  ...
                  >
                    ...
                    <div className="p-8">
                      ...
                      {/* Description */}
                      <p className="text-slate-300 mb-6 leading-relaxed">{formation.description}</p>
...
{/* Cible et programmes */}
                       <div className="mb-6">
                         ...
                         <p className="text-sm text-slate-300 mb-4">{formation.cible}</p>
